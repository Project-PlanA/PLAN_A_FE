...
import { X, Calendar as CalendarIcon, Clock, Phone, CheckCircle2 } from 'lucide-react';
...
const DUMMY_DATA: Consultation[] = [
  {
    id: 1,
    date: new Date(2025, 10, 20), // 2025년 11월 20일
    time: '오전 10:30',
    name: '김순자',
    gender: '여성',
    birthYear: '1956년생',
  ...
  },
  {
    id: 2,
    date: new Date(2025, 10, 20), // 2025년 11월 20일
    time: '오전 10:30', // 이미지의 내용에 맞춰 시간을 변경했습니다.
    name: '이덕화',
    gender: '남성',
    birthYear: '1949년생',
    phone: '010-0000-0000',
                ...
                <DrawerContent className='mx-auto max-w-[390px] rounded-t-[20px]'>
                  <div className='px-5 pt-2 pb-8'>
                    <DrawerHeader className='px-0 pt-0 text-left'>
                      ...
                      <DrawerTitle className='self-start text-xl font-bold text-gray-900'>
                        {item.name}
                      </DrawerTitle>
