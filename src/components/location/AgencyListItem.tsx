...
export default function AgencyListItem({ agency, onClickAgency, disabled = false }: Props) {
  return (
    <article className="w-[350px] mx-auto mb-3 rounded-[10px] bg-white p-4 shadow-[0_0_5px_rgba(0,0,0,0.05)]">
      <div className="flex items-baseline justify-between">
        ...
        {agency.distanceText && (
          <span className="text-[11px] text-[#969696] ml-2">
            {agency.distanceText}
          </span>
        )}
      </div>
      ...
      <div className="mt-3 flex items-start gap-2">
        ...
        <p className="text-[13px] text-[#000000] leading-[18px]">
